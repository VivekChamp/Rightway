...
frappe.require("assets/erpnext/js/financial_statements.js", function() {
	frappe.query_reports["Profitability Analysis custom"] = {
		...
		"formatter": function(value, row, column, data, default_formatter) {
			if (column.fieldname=="account") {
				...
				column.link_onclick =
					"frappe.query_reports['Profitability Analysis custom'].open_profit_and_loss_statement(" + JSON.stringify(data) + ")";
				column.is_tree = true;
			}
	...
	erpnext.dimension_filters.forEach((dimension) => {
		frappe.query_reports["Profitability Analysis custom"].filters[1].options.push(dimension["document_type"]);
	});
